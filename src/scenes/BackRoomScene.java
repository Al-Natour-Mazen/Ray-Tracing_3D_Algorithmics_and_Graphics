...
public class BackRoomScene extends Scene {
    ...
    protected void initObjects() {
        ...
        IntersectableObject wall1 = new Plan(wallOptions, new MyVec3(0.0D, 10.0D, 0.0D), 10.0D); // Mur droit
        IntersectableObject wall2 = new Plan(wallOptions, new MyVec3(0.0D, -10.0D, 0.0D), 10.0D); // Mur gauche
        IntersectableObject wall3 = new Plan(wallOptions, new MyVec3(10.0D, 0.0D, 0.0D), 10.0D); // Mur de droite
